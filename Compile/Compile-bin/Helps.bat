...
REM echo;
REM echo;[·­Òë] Âé·³Ã»À´ÕÒÄã£¬¾Í±ğÈ¥×ÔÕÒÂé·³¡£  - °´ESCÌø¹ı
REM echo;[ÌáÊ¾] µÚÒ»¡¢ËÄ¸ötroubleÊÇ¶¯´Ê£¬µÚ¶ş¡¢Èı¸ötroubleÊÇÃû´Ê¡£
REM words "[-] Never trouble trouble" "till" "trouble troubles you¡£"
REM echo;	                  ----
REM call :showcmd "pause >nul"
REM pause >nul

REM echo;[µ¥´ÊÊÍÒâ]till
REM echo;	v.¸û×÷£»ÀçµØ
REM echo;	prep.Ö±µ½¡­ÎªÖ¹£»Ö±µ½¡­²Å¡­£»ÔÚ¡­Ç°(²»¡­)
REM echo;	conj.Ö±µ½¡­ÎªÖ¹£»ÔÚ¡­Ö®Ç°
REM echo;	n.ÊÕÒøÌ¨£»£¨ÏÖ½ğ³öÄÉ»úµÄ£©·ÅÇ®µÄ³éÌë
REM echo;	ÍøÂçÖ±µ½¡­¡­ÎªÖ¹£»°®µÄÊÄÑÔ£»¸ûÖÖ
REM echo;	µÚÈıÈË³Æµ¥Êı£ºtills  ÏÖÔÚ·Ö´Ê£ºtilling  ¹ıÈ¥Ê½£ºtilled
...
REM start cmatrix
REM echo;	Æô¶¯Êı×ÖÓê³ÌĞò
REM call :showcmd "zms"
REM start zms
REM echo;	ÉèÖÃÎªProgman×Ó´°¿Ú£¬Ç¶Èë×ÀÃæ
